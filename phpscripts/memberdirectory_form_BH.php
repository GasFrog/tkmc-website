...
if (isset($_GET["searchBy"]) || isset($_GET["lodgeNum"])) {
	...
	echo '<a href="http://templarknightsmc.com/member-area/member-directory">Back</a><br>';
	if($result) {
	...
	echo '<form action="http://templarknightsmc.com/member-area/member-directory" method="get">';
