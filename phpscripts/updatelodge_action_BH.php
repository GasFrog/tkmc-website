...
if($result) {
  header("Location: http://templarknightsmc.com/council-area/grand-council/update-lodge?success");
}
else {
  echo 'Failed to update Record for ' . $lodgeName . ' ERROR: ' . mysql_fetch_array($result) . '<br>Query: ' . $query;
}
