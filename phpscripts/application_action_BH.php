...
if ($_POST['rentalUnderstanding'] && $_POST['signature']) {
	...
	$query = 'INSERT INTO ' . $atable . ' (FNAME, LNAME, AGE, STREET_ADDRESS, CITY, STATE, ZIP_CODE, COUNTRY, HOME_TOWN, PHONE, EMAIL, REFERRED_BY, DRIVERS_LICENSE, ENDORSEMENT, M_MAKE, M_MODEL, M_SIZE, M_YEAR, YEARS_RIDING, INSURANCE, AFFILIATIONS, SKILLS, HOW_HEARD, FELONY, CRIMINAL, PAROLE, INVESTIGATION, COURT_ORDER, VIOLENCE, GANGS, DRUGS, DISHONOR, EXPLANATION, RENTAL, SIGNATURE, DATE_APPLIED, IP_ADDRESS) VALUES ("' . mysql_real_escape_string($_POST['firstName']) . '","' . mysql_real_escape_string($_POST['lastName']) . '","' . mysql_real_escape_string($_POST['age']) . '","' . mysql_real_escape_string($_POST['address']) . '","' . mysql_real_escape_string($_POST['city']) . '","' . mysql_real_escape_string($_POST['state']) . '","' . mysql_real_escape_string($_POST['zipCode']) . '","' . mysql_real_escape_string($_POST['country']) . '","' . mysql_real_escape_string($_POST['homeTown']) . '","' . mysql_real_escape_string($_POST['phoneNum']) . '","' . mysql_real_escape_string($_POST['emailAddr']) . '","' . mysql_real_escape_string($referredBy) . '","' . mysql_real_escape_string($driversLicense) . '","' . mysql_real_escape_string($_POST['currentEndorsement']) . '","' . mysql_real_escape_string($_POST['mcMake']) . '","' . mysql_real_escape_string($_POST['mcModel']) . '","' . mysql_real_escape_string($mcSize) . '","' . mysql_real_escape_string($_POST['mcYear']) . '","' . mysql_real_escape_string($_POST['mcYearsRiding']) . '","' . mysql_real_escape_string($insuranceCompany) . '","' . mysql_real_escape_string($membershipsHeld) . '","' . mysql_real_escape_string($_POST['skills']) . '","' . mysql_real_escape_string($_POST['howHeard']) . '","'. mysql_real_escape_string($_POST['felony']) . '","' . mysql_real_escape_string($_POST['criminal']) . '","' . mysql_real_escape_string($_POST['parole']) . '","' . mysql_real_escape_string($_POST['investigation']) . '","' . mysql_real_escape_string($_POST['courtOrder']) . '","' . mysql_real_escape_string($_POST['violence']) . '","' . mysql_real_escape_string($_POST['gangs']) . '","' . mysql_real_escape_string($_POST['drugs']) . '","' . mysql_real_escape_string($_POST['dishonorable']) . '","' . mysql_real_escape_string($_POST['yesExplanations']) . '","' . mysql_real_escape_string($_POST['rentalUnderstanding']) . '","' . mysql_real_escape_string($_POST['signature']) . '","' . mysql_real_escape_string($_POST['dateApplied']) . '","' . mysql_real_escape_string($_POST['ipAddress']) . '")';
