   ...
   if (!defined('SCRIPTS_DIR')) {
	...
	if(isset($_GET["lodgeNum"])) {
		...
		if($result) {
			...
			echo '<form action="http://templarknightsmc.com/council-area/grand-council/update-lodge" method="get">';
			...
			echo 'Lodge Code (5 characters): <input type="text" name="lodgeCode" value="' . $row['LODGE_CODE'] . '" /><p>';
